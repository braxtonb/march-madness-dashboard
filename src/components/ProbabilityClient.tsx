            ...
            <table className="min-w-[850px] w-full text-sm">
              <thead>
                <tr className="border-b border-outline-variant">
                  ...
                  <th className="px-2 py-2 text-left font-label text-[10px] uppercase tracking-wider text-on-surface-variant cursor-default"><span className="inline-flex items-center gap-1"><span className="text-sm">🏆</span>Champion</span></th>
