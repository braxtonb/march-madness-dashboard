...
export default async function HeadToHeadPage() {
  ...
  return (
    <div className="space-y-section">
      ...
      <HeadToHeadContent brackets={data.brackets} picks={data.picks} games={data.games} analyticsObj={analyticsObj} pickRatesObj={pickRatesObj} currentRound={data.meta.current_round} teams={data.teams} />
    </div>
  );
}
